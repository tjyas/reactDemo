var PartyItem = React.createClass({displayName: "PartyItem",
    //配置props的要求规范
    propTypes: {
...
/*        var cx = React.addons.classSet;
        ...
        if (state.list.length>1) {
            var hello = React.createElement(HelloMessage, {name: state.list[0].text});
        }else{
            var hello = React.createElement("div", null);
        }
            ...
            React.createElement("div", null, 
                hello, 
                    ...
                    state.list.map(function(item,key){
                        ...
                        if (!key) {
                            return (
                                React.createElement("div", {"data-role": "item", className: "item item-first", "data-name": props.type, key: key}, 
                                    React.createElement("input", {type: "hidden", name: "id", value: item.id}), 
                                    React.createElement("input", {type: "hidden", name: "position", value: item.position}), 
                                    React.createElement("select", {name: "position", className: "item-select", disabled: "disabled", value: item.position}, 
                                        React.createElement("option", {value: item.position}, " ", props.selectArr[0])
                                    ), 
                                    React.createElement("input", {type: "text", name: "text", className: "item-input", placeholder: props.placeholder, value: item.text, onChange: me.changeHandle.bind(me,key)}), 
                                    React.createElement("span", {onClick: me.addHandle, className: "item-action", title: state.title}, "增加")
                                )
                            );
                        }else{
                            return (
                                React.createElement("div", {"data-role": "item", className: "item", "data-name": props.type, key: key}, 
                                    React.createElement("input", {type: "hidden", name: "id", value: item.id}), 
                                    React.createElement("select", {name: "position", className: "item-select", value: item.position, onChange: me.changeHandle.bind(me,key)}, 
                                        
                                            options.map(function(option){
                                                return(
                                                    React.createElement("option", {value: option}, props.selectArr[option])
                                                );
                                            })
                                        
                                    ), 
                                    React.createElement("input", {type: "text", name: "text", className: "item-input", placeholder: props.placeholder, value: item.text, onChange: me.changeHandle.bind(me,key)}), 
                                    React.createElement("span", {onClick: me.deleteHandle.bind(me,key), className: "item-action"}, "删除")
                                )
                            );
                        }
                    })
...
var HelloMessage = React.createClass({displayName: "HelloMessage",
    ...
    render: function() {
        var me = this;
        return React.createElement("h1", {className: "haha", onClick: me.helloClick}, "Hello ", this.props.name, " ", React.createElement("span", {onClick: me.spanClick}, "123"));
    }
});

ReactDOM.render(
  React.createElement(PartyItem, React.__spread({},  props)),
